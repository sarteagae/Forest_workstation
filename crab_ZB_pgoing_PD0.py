if __name__ == '__main__':
    ...
    config.General.workArea = 'HeavyIon_Forest_ZB'
    ...
    config.Data.totalUnits = 487 ###how many files to analyze
    ...
    config.General.requestName = 'HeavyIon_Forest_pPb_8p16TeV_pgoing_ZB_PD0'
    config.Data.inputDataset = '/PAZeroBias0/PARun2016C-PromptReco-v1/AOD'
    ...
    config.Data.outputDatasetTag = 'HeavyIon_Forest_pPb_8p16TeV_pgoing_ZB_PD0'
    submit(config)
