if __name__ == '__main__':
    ...
    config.General.workArea = 'HeavyIon_Forest_ZB1'
    ...
    config.Data.totalUnits = 444 ###how many files to analyze
    ...
    config.General.requestName = 'HeavyIon_Forest_pPb_8p16TeV_pgoing_ZB_PD1'
    config.Data.inputDataset = '/PAZeroBias1/PARun2016C-PromptReco-v1/AOD'
    ...
    config.Data.outputDatasetTag = 'HeavyIon_Forest_pPb_8p16TeV_pgoing_ZB_PD1'
    submit(config)
