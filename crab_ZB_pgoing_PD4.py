if __name__ == '__main__':
    ...
    config.General.workArea = 'HeavyIon_Forest_ZB4'
    ...
    config.General.requestName = 'HeavyIon_Forest_pPb_8p16TeV_pgoing_ZB_PD4'
    config.Data.inputDataset = '/PAZeroBias4/PARun2016C-PromptReco-v1/AOD'
    ...
    config.Data.outputDatasetTag = 'HeavyIon_Forest_pPb_8p16TeV_pgoing_ZB_PD4'
    submit(config)
