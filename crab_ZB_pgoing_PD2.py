if __name__ == '__main__':
    ...
    config.General.workArea = 'HeavyIon_Forest_ZB2'
    ...
    config.General.requestName = 'HeavyIon_Forest_pPb_8p16TeV_pgoing_ZB_PD2'
    config.Data.inputDataset = '/PAZeroBias2/PARun2016C-PromptReco-v1/AOD'
    ...
    config.Data.outputDatasetTag = 'HeavyIon_Forest_pPb_8p16TeV_pgoing_ZB_PD2'
    submit(config)
